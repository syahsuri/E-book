...
<footer>
    <hr>
    <ul class=" ul d-flex">
        <li class="li"><a href="/article4" class="a"><i class="bi bi-chevron-left "></i> {{ $articles[4]->nama_article }}  </a></li>
        <li class="li fw-bolder b">{{ $articles[5]->nama_article }} </li>
        <li class="li"><a href="/article6" class="a"> {{ $articles[6]->nama_article }} <i class="bi bi-chevron-right"></i></a>  </li>
    </ul>
</footer>
@endsection